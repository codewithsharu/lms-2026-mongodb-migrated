...
export const userAPI = {
  ...
  bulkUpdateStudentAssignments: (ids, data) => api.post('/users/bulk-update-students', { ids, ...data }),
...
export const compilerAPI = {
  ...
  listTeacherChallenges: (params) => api.get('/compiler/challenges/my', { params }),
  listCentralChallenges: (params) => api.get('/compiler/challenges/central', { params }),
  ...
  updateChallengeVisibility: (challengeId, isPublic) => api.put(`/compiler/challenges/${challengeId}/visibility`, { is_public: isPublic }),
  cloneChallenge: (challengeId) => api.post(`/compiler/challenges/${challengeId}/clone`),
...
export const assessmentAPI = {
  ...
  getCentralTemplates: () => api.get('/assessments/templates/central'),
